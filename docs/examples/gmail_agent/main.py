...
from adk_blueprints import GmailAgent


load_dotenv()

APP_NAME = 'gmail_agent_example'
USER_ID = 'user_id'
SESSION_ID = 'session_id'

gmail_agent = GmailAgent(model='gemini-2.5-flash')
...
async def main():
    ...
    try:
        ...
        runner = Runner(app_name=APP_NAME, agent=gmail_agent, session_service=session_service, memory_service=memory_service)
